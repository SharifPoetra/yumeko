...
module.exports.run = async (client, msg, args) => {
  ...
  try {
    const { body } = await client.snek.get("https://nekos.life/api/v2/img/hug");
    const embed = new RichEmbed()
      .setColor("RANDOM")
      .setDescription(reaction(client, msg.author, user, "huging"))
      .setImage(body.url);
...
module.exports.help = {
  name: "hug",
  description: "huging some user",
  usage: "hug [mention | id]",
  example: ["hug", "hug @yumeko", "hug 10383642829282"]
};
